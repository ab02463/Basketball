...
class EmployeeEmailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_email" do
    assert_difference('EmployeeEmail.count') do
      post employee_emails_url, params: { employee_email: { email: @employee_email.email, employee_id: @employee_email.employee_id } }
    end
  ...
  test "should update employee_email" do
    patch employee_email_url(@employee_email), params: { employee_email: { email: @employee_email.email, employee_id: @employee_email.employee_id } }
